                            ...
                            <Grid container item xs={12} spacing={0}>
                                {data.length ? data.map((i: User, index) => {
                                        return (<div className={"carsList"} key={index}>
                                                ...
                                                <div className={"info"} >
                                                    <div style={{fontSize:"22px", color:"#707070", marginTop: "5px"}}>{i.name}</div>
                                                    ...
                                                    <div className={"info2"}>
                                                        <div className={"part1"}>
                                                            ...
                                                            <p style={{fontSize:"17px", color:"black",marginTop:"5px", display: "flex", alignItems:"center"}}>
                                                                <AirlineSeatIndividualSuiteIcon style={{fontSize:"medium"}}/> {i.id}Beds</p>
                                                        </div>
                                                        <div className={"part2"}>
                                                            <div style={{fontSize:"17px", color:"#707070",marginTop:"5px"}}>{i.id > 30? 1 : i.id}.12.21</div>
                                                            <div style={{fontSize:"17px", color:"#707070",marginTop:"5px"}}>House</div>
                                                            <div style={{fontSize:"17px", color:"#707070",marginTop:"5px"}}><BathtubIcon style={{fontSize:"medium"}}/> {i.id} Bathroom</div>
                                                        </div>
                                                    </div>
